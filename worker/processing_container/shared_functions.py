...
def compose_custom_instructions(user_instructions: str, autogenerated_instructions: str) -> str:
    parts = (str(user_instructions or "").strip(), str(autogenerated_instructions or "").strip())
...
def naming_convention(path, file_type):
    ...
    match file_type:
        ...
        case "custom_instructions_autogenerated":
            return f"{path_without_ext}.custom-instructions.autogenerated.txt"
        case "subtitles_base":
